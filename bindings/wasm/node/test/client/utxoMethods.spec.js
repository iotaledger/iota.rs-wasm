...
describe.skip('UTXO methods', () => {
    it('gets receipts', async () => {
        ...
        const receiptsMigratedAt = await client.getReceiptsMigratedAt(milestoneIndex);
    ...
    it('get alias/nft/foundry outputId rejects with 404 for invalid IDs', async () => {
        await expect(client.aliasOutputId('0x03119f37e7ad40608fc7ab15db49390abc233648c95e78141ff2e298f60d7a95')).rejects.toMatch('404');
        await expect(client.nftOutputId('0x03119f37e7ad40608fc7ab15db49390abc233648c95e78141ff2e298f60d7a95')).rejects.toMatch('404');
        await expect(client.foundryOutputId('0x03119f37e7ad40608fc7ab15db49390abc233648c95e78141ff2e298f60d7a9541ff2e60d7a9')).rejects.toMatch('404');
    });
});
