 ...
 */
export declare type QueryParameter = Address | AliasAddress | HasStorageDepositReturn | StorageDepositReturnAddress | HasTimelock | TimelockedBefore | TimelockedAfter | HasExpiration | ExpiresBefore | ExpiresAfter | ExpirationReturnAddress | Sender | Tag | Issuer | StateController | Governor | CommonQueryParameters;
/** Query parameters for filtering Alias Outputs */
export declare type AliasQueryParameter = StateController | Governor | Issuer | Sender | CommonQueryParameters;
/** Query parameters for filtering Foundry Outputs */
export declare type FoundryQueryParameter = AliasAddress | CommonQueryParameters;
/** Query parameters for filtering Nft Outputs */
export declare type NftQueryParameter = Address | AliasAddress | HasStorageDepositReturn | StorageDepositReturnAddress | HasTimelock | TimelockedBefore | TimelockedAfter | HasExpiration | ExpiresBefore | ExpiresAfter | ExpirationReturnAddress | Sender | Tag | CommonQueryParameters;
/** Shared query parameters*/
declare type CommonQueryParameters = HasNativeTokens | MinNativeTokenCount | MaxNativeTokenCount | CreatedAfter | CreatedBefore | PageSize | Cursor;
